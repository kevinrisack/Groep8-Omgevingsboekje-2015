...
{
    using DigitaalOmgevingsboek.Models;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DigitaalOmgevingsboek.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(DigitaalOmgevingsboek.Models.ApplicationDbContext context)
        {
            ...
            if (!context.Users.Any(u => u.Email.Equals("niels.deryckere@student.howest.be")))
            {
                ...
                manager.Create(user, "Groep8Omgevingsboekje");
