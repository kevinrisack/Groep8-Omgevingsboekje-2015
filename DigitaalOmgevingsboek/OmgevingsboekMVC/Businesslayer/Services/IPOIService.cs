...
namespace OmgevingsboekMVC.Businesslayer.Services
{
    public interface IPOIService
    {
        ...
        System.Collections.Generic.List<DigitaalOmgevingsboek.POI> GetPOIByDoelgroep(DigitaalOmgevingsboek.Doelgroep doelgroep);
        System.Collections.Generic.List<DigitaalOmgevingsboek.POI> GetPOIByThema(DigitaalOmgevingsboek.Thema thema);
